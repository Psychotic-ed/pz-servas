SandboxVars = {
    ...
    PlayersOnMap = {
        ...
        -- Distance after which player won't show on a map. (Doesn't affect admins) Min: -1 Max: 999999999 Default: 999999999
        MaxDistance = 999999999,
    },
    pointblankhf = {
        -- Any xp gains from killing a zombie will be multiplied by this value Min: 0.00 Max: 1.00 Default: 0.05
        PointBlankXpMultiplier = 0.1,
        ...
        -- "(NOT YET IMPLEMENTED)" Min: 0.00 Max: 10.00 Default: 0.35
        PointBlankCooldownDuration = 0.35,
        -- "(NOT YET IMPLEMENTED) When cooldown is active, this value determines chance for point blank to hit again. Rises to 100% as cooldown refresh approaches" Min: 0.00 Max: 1.00 Default: 0.50
